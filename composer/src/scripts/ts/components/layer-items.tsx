...
class LayerItems extends React.Component<LayerItemsProps, LayerItemsState> {
  ...
  constructor(props: LayerItemsProps) {
    ...
    this.onTimelineSelectorMouseOver =
      this.onTimelineSelectorMouseOver.bind(this);
    this.onTimelineSelectorMouseOut =
      this.onTimelineSelectorMouseOut.bind(this);
    this.onTimelineSelectorMouseMove =
      this.onTimelineSelectorMouseMove.bind(this);
    this.onTimelineSelectorMouseDown =
      this.onTimelineSelectorMouseDown.bind(this);
  }
